...
import com.kaysen.shop.utils.CodeUtils;
...
public class LoginController extends BaseController {
     ...
     */
    @RequestMapping("/code")
    public void getImageCode(HttpServletResponse response) throws Exception {
        ByteArrayOutputStream output = new ByteArrayOutputStream();
        String code = CodeUtils.drawImg(output);
    ...
    public Object doLogin(SysUser sysUser, String code) throws Exception {
        ...
        if (sysUser != null && StringUtils.isNotBlank(sysUser.getUserName()) && StringUtils.isNotBlank(sysUser.getPassword())) {
            ...
            map.put("isAccuss", false);
            try {
                subject.login(token);
                map.put("isAccuss", true);
                errMsg = "登录成功";
