 ...
 public class CompressPic { 
 	...
 	public static void main(String[] arg) { 
 		...
 		//for (int i = 0; i < 100; i++) { 
 			...
 			System.out.println(mypic.compressPic("e:\\", "e:\\test\\", "1.jpg", "r1"+1+".jpg",800, 600, true)); 
 			int end = (int) System.currentTimeMillis(); // 结束时间 
 			int re = end-start; // 但图片生成处理时间 
 			count += re; System.out.println("第" + (0+1) + "张图片压缩处理使用了: " + re + "毫秒"); 
 			System.out.println("输出的图片大小：" + mypic.getPicSize("e:\\test\\r1"+0+".jpg")/1024 + "KB"); 
 	//}
