package com.kaysen.shop.utils.log;

import com.kaysen.shop.utils.IpUtil;
...
public class Logs {
	...
	private static String msgAppendIp(String msg){
		StringBuilder sb = new StringBuilder(IpUtil.getIp());
	...
	public static void trace(String msg) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.TRACE_INT, msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void trace(String msg, Throwable t) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.TRACE_INT, msgAppendIp(msg), EMPTY_ARRAY, t);
	}
	...
	public static void info(String msg) {
		getLocationAwareLogger(DEPTH).log(null, FQCN, LocationAwareLogger.INFO_INT,
				msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void info(Marker marker, String msg) {
		getLocationAwareLogger(DEPTH).log(marker, FQCN,
				LocationAwareLogger.INFO_INT, msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void info(Marker marker, String msg, Throwable t) {
		getLocationAwareLogger(DEPTH).log(marker, FQCN,
				LocationAwareLogger.INFO_INT, msgAppendIp(msg), EMPTY_ARRAY, t);
	}
	...
	public static void debug(String msg) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.DEBUG_INT, msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void debug(String msg, Throwable t) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.DEBUG_INT, msgAppendIp(msg), EMPTY_ARRAY, t);
	}
	...
	public static void warn(Marker marker, String msg) {
		getLocationAwareLogger(DEPTH).log(marker, FQCN,
				LocationAwareLogger.WARN_INT, msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void warn(Marker marker, String msg, Throwable t) {
		getLocationAwareLogger(DEPTH).log(marker, FQCN,
				LocationAwareLogger.WARN_INT, msgAppendIp(msg), EMPTY_ARRAY, t);
	}
	...
	public static void error(String msg) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.ERROR_INT, msgAppendIp(msg), EMPTY_ARRAY, null);
	}
	...
	public static void error(String msg, Throwable t) {
		getLocationAwareLogger(DEPTH).log(null, FQCN,
				LocationAwareLogger.ERROR_INT, msgAppendIp(msg), EMPTY_ARRAY, t);
	}
